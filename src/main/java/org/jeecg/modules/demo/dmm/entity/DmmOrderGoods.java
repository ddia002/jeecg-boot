 ...
 */
@Data
@TableName("dmm_order_goods")
public class DmmOrderGoods implements Serializable {
	...
	/**订单状态(1.待付款   2.待收货   3.交易完成  4.交易关闭)*/
	...
	/**商品单价*/
	private java.math.BigDecimal goodsUnitMoney;
	/**商品数量*/
	private java.lang.Integer goodsNum;
	/**商品总价格*/
	private java.math.BigDecimal goodsTotalMoney;
	/**运费*/
